from ThesisPackage.Environments.soccer.soccer_env_multi_randomized import SoccerGame
...
if __name__ == "__main__":
    ...
    test_env = SoccerGame(20, 12, sequence_length=2, vocab_size=3, noise_team=[1, -1])

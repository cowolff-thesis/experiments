...
from ThesisPackage.RL.Centralized_PPO_LSTM.multi_ppo import PPO_Multi_Agent_Centralized
...
if __name__ == "__main__":
    ...
    for sequence_length in [1, 2, 3, 4, 0]:
        ...
        agent = PPO_Multi_Agent_Centralized(envs, num_minibatches=64, device="mps")

        agent.train(total_timesteps, tensorboard_folder="OneHot", exp_name=f"collect_seq_{sequence_length}", anneal_lr=True, learning_rate=0.001, num_checkpoints=60, num_minibatches=64)
